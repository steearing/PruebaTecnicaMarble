...
public class StepsDefinitions {
	...
	public void abro_el_navegador_e_ingreso_al_buscador_de_google() {
		System.setProperty(configuracion.leerArchivo("webDriver").getMensaje(), configuracion.leerArchivo("ruta.driver").getMensaje());
	...
	public void dijito_la_palabra_pruebaz() throws Exception {
		Reporter.addScreenCaptureFromPath(utilidades.getscreenshot(driver,configuracion.leerArchivo("ruta.Evidencia").getMensaje()));
